...
export class ApiService {
  ...
  async getGuardianProfile(accessToken: string): Promise<ApiResponse<{
    id: string;
    firstName: string;
    lastName: string;
    relationship: string;
  ...
  // Image upload (web version using File instead of URI)
  async uploadImage(file: File, accessToken: string): Promise<ApiResponse<{ filename: string; url: string }>> {
    try {
